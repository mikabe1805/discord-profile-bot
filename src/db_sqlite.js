...
async function initDatabase() {
    try {
        ...
        await dbRun(`CREATE INDEX IF NOT EXISTS idx_profiles_guild_user ON profiles(guild_id, user_id)`);
        await dbRun(`CREATE INDEX IF NOT EXISTS idx_tags_guild ON tags(guild_id)`);
        await dbRun(`CREATE INDEX IF NOT EXISTS idx_tag_members_guild_tag ON tag_members(guild_id, tag_slug)`);
        await dbRun(`CREATE INDEX IF NOT EXISTS idx_tag_members_user ON tag_members(guild_id, user_id)`);
